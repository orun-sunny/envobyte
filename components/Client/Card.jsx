...
const Card = ({ name, platform, profile }) => {
  return (
    <div className="flex flex-col rounded-lg p-2.5 px-6 pt-6 pb-[27px] relative border border-gray-400/30 ">
      ...
      <p className="text-balance text-[14px] leading-[22px] text-[#424242] mb-5 font-inter">
      ...
      <div className="flex gap-2 items-center">
        ...
        <div className="flex-1">
          <span className="font-inter text-[#0A2C8C] font-medium text-[18px] leading-[24px] ">
            {name}
          </span>
          <span className="flex gap-1 ">
            <span>{platform === "f" ? <FiverrIcon /> : <UpworkIcon />}</span>
            <p className="font-inter text-[rgba(0,18,70,30%)] font-medium text-[14px] leading-[20px] ">
